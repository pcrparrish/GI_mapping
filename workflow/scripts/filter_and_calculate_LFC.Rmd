...
* use only expressed pan-essential genes as + controls? - yes, if there is RNAseq data available
...
### Done:
* add "Rep" back into replicate labels - done for plots only
...
unadjusted_norm_ctrl_violin_plot +
    facet_wrap(~rep, labeller = labeller(rep = label_facet(d.lfc_annot$rep, "Rep")))
...
adjusted_norm_ctrl_violin_plot +
    facet_wrap(~rep, labeller = labeller(rep = label_facet(d.lfc_annot_adj$rep, "Rep")))
...
d.lfc_annot_adj_single %>%
  ...
  facet_wrap(~rep, labeller = labeller(rep = label_facet(d.lfc_annot_adj_single$rep, "Rep")))
...
ggplot(d.lfc_annot_adj_double_plot, aes(x = lfc_adj3, fill = n_genes_expressed)) +
  ...
  plot_theme +
  theme(aspect.ratio = wide_ar) +
  facet_wrap(~rep, labeller = labeller(rep = label_facet(d.lfc_annot_adj_double_plot$rep, "Rep")))
...
adjusted_norm_ctrl_violin_plot +
    facet_wrap(~rep, labeller = labeller(rep = label_facet(d.lfc_annot_adj_target$rep, "Rep")))
